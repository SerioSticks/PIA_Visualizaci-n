...
#Donde se crea la aplicación (Ventana que avisa que la clave a utilizar existe, por lo tanto se puede proseguir)
...
class Ui_ClaveExistente(object):
    ...
    def retranslateUi(self, ClaveExistente):
        ...
        self.label.setText(_translate("ClaveExistente", "<html><head/><body><p align=\"center\"><span style=\" font-size:14pt; font-weight:600;\">CLAVE EXISTENTE</span></p><p align=\"center\"><span style=\" font-size:14pt; font-weight:600;\">PUEDE ACTUALIZAR</span></p></body></html>"))
